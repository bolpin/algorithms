...
describe('RemoveLast', () => {
  test('RemoveLast does not throw node when list is empty', () => {
    const l = new List();
    expect(() => {
      l.removeLast();
    }).not.toThrow();
...
describe('RemoveAt', () => {
  ...
  test('removeAt does not crash just past the last node', () => {
    const l = new List();
    l.insertLast(1);
    l.insertLast(2);
    l.insertLast(3);
...
describe('InsertAt', () => {
  ...
  test('inserts a new node with data at an out-of-range index when the list is empty', () => {
    const l = new List();
    l.insertAt('hi', 3);
    expect(l.getFirst().data).toEqual('hi');
    expect(l.size()).toEqual(1);
